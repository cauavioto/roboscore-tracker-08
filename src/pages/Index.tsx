...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-background bg-grid pb-16">
      {/* Header */}
      ...
      <main className="container mx-auto px-4 py-6 space-y-6 max-w-4xl">
        ...
        <nav className="fixed bottom-0 left-0 right-0 border-t border-border bg-card/95 backdrop-blur-sm z-20">
          <div className="container mx-auto flex max-w-4xl">
            ...
            <button onClick={() => navigate("/analytics")} className="flex-1 flex flex-col items-center gap-1 py-3 text-muted-foreground hover:text-foreground transition-all">
              <TrendingUp size={20} />
